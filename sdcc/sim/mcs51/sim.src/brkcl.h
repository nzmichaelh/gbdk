...
public:
  ...
  cl_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
  ~cl_brk(void);
...
public:
  ...
  cl_fetch_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_ev_brk(int inr, long iaddr, enum brk_perm iperm, int ihit,
...
{
public:
  cl_wi_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_ri_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_wx_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_rx_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_ws_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_rs_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
{
public:
  cl_rc_brk(int inr, long iaddr, enum brk_perm iperm, int ihit);
...
public:
  ...
  virtual void del_bp(long addr);
  virtual class cl_brk *get_bp(long addr, int *idx);
  virtual bool bp_at(long addr);
};
